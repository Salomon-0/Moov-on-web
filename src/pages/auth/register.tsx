...
function FloatingInput({
  ...
  return (
    <div className="space-y-1">
      <div
        className={`relative flex items-center gap-3 px-4 py-3.5 rounded-2xl border transition-all duration-300 bg-white ${error
      ...
      >
        ...
        <div className="relative flex-1">
          <label
            htmlFor={id}
            className={`absolute left-0 transition-all duration-200 pointer-events-none ${lifted
                ...
                <div className="flex items-center gap-3 mb-5">
                  {STEPS.map((label, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <div
                        className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-black transition-all duration-400 ${i < step
                    ...
                    <div className="flex flex-wrap gap-2">
                      {["Antananarivo", "Toamasina", "Mahajanga", "Toliara", "Fianarantsoa", "Autre"].map((c) => (
                        <button
                          key={c}
                          onClick={() => setCity(c)}
                          className={`text-xs font-semibold px-4 py-2 rounded-full border transition-all duration-200 ${city === c
                      ...
                      {PREFS.map((p, i) => {
                        ...
                        return (
                          <button
                            ...
                            className={`anim-right flex flex-col items-center gap-1.5 py-4 rounded-2xl border text-xs font-bold transition-all duration-300 ${active
                  ...
                  <div className="anim-right" style={{ animationDelay: "0.44s" }}>
                    <label className="flex items-start gap-3 cursor-pointer select-none">
                      <div
                        ...
                        className={`w-5 h-5 rounded-md border-2 flex items-center justify-center mt-0.5 shrink-0 transition-all duration-200 ${terms ? "bg-zinc-900 border-zinc-900" : "border-zinc-300 hover:border-zinc-500"
                          }`}
                      >
                        {terms && (
